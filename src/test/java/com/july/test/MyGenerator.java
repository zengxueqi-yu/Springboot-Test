...
public class MyGenerator {
	...
	private String author="zqk";  //代码注释中的作者
	private String url="jdbc:mysql://127.0.0.1:3306/test?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai";
	...
	public StrategyConfig getStrategyConfig() {
		...
		strategy.setTablePrefix(new String[] { moduleName + "_" });// 表前缀 有则使用,没有则不用
